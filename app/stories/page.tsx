...
const farmerStories = [
  {
    ...
    location: "Bihar",
    crop: "Rice",
    title: "How Krishi Vaani helped me increase my rice yield by 40%",
...
export default function Stories() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-green-800 mb-6">{translate("Real Farmer Success Stories")}</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {farmerStories.map((story) => (
          <Card key={story.id} className="overflow-hidden">
            <div className="relative h-48 cursor-pointer" onClick={() => setSelectedStory(story)}>
            ...
            <CardContent className="pt-4">
              <h3 className="font-semibold text-lg text-green-800 mb-1">{story.title}</h3>
