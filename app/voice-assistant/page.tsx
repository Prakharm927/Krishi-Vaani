...
export default function VoiceAssistantPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-green-800 mb-6">{translate("Voice Assistant")}</h1>

      <div className="bg-white rounded-xl shadow-sm p-6">
        <div className="mb-4">
          <h2 className="text-xl font-semibold text-green-800 mb-2 flex items-center gap-2">
            <span>{translate("Ask your agricultural questions")}</span>
            {isProcessing && <span className="inline-block h-2 w-2 rounded-full bg-green-600 animate-pulse"></span>}
          </h2>
          <p className="text-gray-600 text-sm">{translate("Speak or type to get agricultural advice")}</p>
        </div>
